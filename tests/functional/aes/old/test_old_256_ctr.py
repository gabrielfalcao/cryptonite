...
"\033[0;32min-memory AES CTR 256 \033[1;36m[old implementation]\033[0m"

from cryptonite.aes.ctrold import encrypt256
from cryptonite.aes.ctrold import decrypt256
